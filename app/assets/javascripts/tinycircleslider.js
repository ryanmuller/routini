...
(function($){
    ...
    var iOrginalAngle = 0, iCounter = 0, iCurrent = 0, iFramerate = 1;
    var iChildsLength = 60*60;
    ...
    function setCurrent(angle){
		...
		function setCSS(angle, bFireCallback){
			...
			//iCurrent = (Math.min(iChildsLength -1, Math.round(iDegrees / 360 * iChildsLength)));
      $('#timer-time').text(ShuffClock.displayTime(iCurrent));
